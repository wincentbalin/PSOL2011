...
\StageDir{Музыка.
          \par Служка приносит хупу, подаёт её рассказчику. Рассказчик устанавливает хупу.
          Служка просит жестом чаевые.}
...
\StageDir{Входит \m. С другой стороны -- \am.\\Шум в зале.}
...
\StageDir{\m и \am сердито уходят.}
...
\ahspeaks \direct{Напевает на мотив \textsc{Крутится вертится шар голубой}}
\begin{verse}
...
\mspeaks \direct{Поёт на мотив \textsc{Прекрасная маркиза}}
\begin{verse}
...
\begin{verse}
ООН прислал протеста ноту.\\
Европа собирает рать,\\
Чтобы за твою, Аман, работу\\
